 ...
 */
export declare function accessControlCreate(client: LivepeerCore, options?: RequestOptions): Promise<Result<operations.CreateSigningKeyResponse, SDKError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=accessControlCreate.d.ts.map