 ...
 */
async function accessControlUpdate(client, requestBody, keyId, options) {
    var _a;
    const input = {
        requestBody: requestBody,
        keyId: keyId,
    };
    const parsed = (0, schemas_js_1.safeParse)(input, (value) => operations.UpdateSigningKeyRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
