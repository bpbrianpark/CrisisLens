 ...
 */
export declare function generateAudioToText(client: LivepeerCore, request: components.BodyGenAudioToText, options?: RequestOptions): Promise<Result<operations.GenAudioToTextResponse, errors.GenAudioToTextResponseBody | errors.GenAudioToTextGenerateResponseBody | errors.GenAudioToTextGenerateResponseResponseBody | errors.GenAudioToTextGenerateResponse415ResponseBody | errors.GenAudioToTextGenerateResponse422ResponseBody | errors.GenAudioToTextGenerateResponse500ResponseBody | SDKError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
