 ...
 */
export declare function roomCreateUser(client: LivepeerCore, roomUserPayload: components.RoomUserPayload, id: string, options?: RequestOptions): Promise<Result<operations.CreateRoomUserResponse, SDKError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=roomCreateUser.d.ts.map