...
exports.roomCreateUser = roomCreateUser;
 ...
 */
async function roomCreateUser(client, roomUserPayload, id, options) {
    var _a;
    const input = {
        roomUserPayload: roomUserPayload,
        id: id,
    };
    const parsed = (0, schemas_js_1.safeParse)(input, (value) => operations.CreateRoomUserRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
    const payload = parsed.value;
    const body = (0, encodings_js_1.encodeJSON)("body", payload["room-user-payload"], {
        explode: true,
    });
    const pathParams = {
    ...
    const path = (0, url_js_1.pathToFunc)("/room/{id}/user")(pathParams);
    ...
    const [result] = await M.match(M.json(201, operations.CreateRoomUserResponse$inboundSchema, {
        key: "room-user-response",
    }), M.fail(["4XX", "5XX"]), M.json("default", operations.CreateRoomUserResponse$inboundSchema, {
        key: "error",
...
//# sourceMappingURL=roomCreateUser.js.map