 ...
 */
async function roomStartEgress(client, roomEgressPayload, id, options) {
    var _a;
    const input = {
        roomEgressPayload: roomEgressPayload,
        id: id,
    };
    const parsed = (0, schemas_js_1.safeParse)(input, (value) => operations.StartRoomEgressRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
