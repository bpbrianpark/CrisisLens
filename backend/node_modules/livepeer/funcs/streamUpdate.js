 ...
 * Update a stream
 */
async function streamUpdate(client, streamPatchPayload, id, options) {
    var _a;
    const input = {
        streamPatchPayload: streamPatchPayload,
        id: id,
    };
    const parsed = (0, schemas_js_1.safeParse)(input, (value) => operations.UpdateStreamRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
