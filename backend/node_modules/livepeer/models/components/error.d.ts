...
export declare function errorTToJSON(errorT: ErrorT): string;
export declare function errorTFromJSON(jsonString: string): SafeParseResult<ErrorT, SDKValidationError>;
