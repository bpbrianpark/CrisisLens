...
/** @internal */
export declare const ViewershipMetric$inboundSchema: z.ZodType<ViewershipMetric, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const ViewershipMetric$outboundSchema: z.ZodType<ViewershipMetric$Outbound, z.ZodTypeDef, ViewershipMetric>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace ViewershipMetric$ {
    /** @deprecated use `ViewershipMetric$inboundSchema` instead. */
    const inboundSchema: z.ZodType<ViewershipMetric, z.ZodTypeDef, unknown>;
    /** @deprecated use `ViewershipMetric$outboundSchema` instead. */
    const outboundSchema: z.ZodType<ViewershipMetric$Outbound, z.ZodTypeDef, ViewershipMetric>;
    /** @deprecated use `ViewershipMetric$Outbound` instead. */
    type Outbound = ViewershipMetric$Outbound;
}
export declare function viewershipMetricToJSON(viewershipMetric: ViewershipMetric): string;
export declare function viewershipMetricFromJSON(jsonString: string): SafeParseResult<ViewershipMetric, SDKValidationError>;
//# sourceMappingURL=viewershipmetric.d.ts.map