...
const generateLlm_js_1 = require("../funcs/generateLlm.js");
...
class Generate extends sdks_js_1.ClientSDK {
     ...
     */
    async llm(request, options) {
        return (0, fp_js_1.unwrapAsync)((0, generateLlm_js_1.generateLlm)(this, request, options));
    }
}
