...
export declare class Room extends ClientSDK {
     ...
     * @deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
     */
    startEgress(roomEgressPayload: components.RoomEgressPayload, id: string, options?: RequestOptions): Promise<operations.StartRoomEgressResponse>;
    /**
     ...
     * @deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
     */
    createUser(roomUserPayload: components.RoomUserPayload, id: string, options?: RequestOptions): Promise<operations.CreateRoomUserResponse>;
    /**
     * Get user details
     *
     * @deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
     ...
     * @deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
     */
    updateUser(roomUserUpdatePayload: components.RoomUserUpdatePayload, id: string, userId: string, options?: RequestOptions): Promise<operations.UpdateRoomUserResponse>;
    /**
