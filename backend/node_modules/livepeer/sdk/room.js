...
class Room extends sdks_js_1.ClientSDK {
     ...
     * @deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
     */
    async startEgress(roomEgressPayload, id, options) {
        return (0, fp_js_1.unwrapAsync)((0, roomStartEgress_js_1.roomStartEgress)(this, roomEgressPayload, id, options));
    }
    /**
     ...
     * @deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
     */
    async createUser(roomUserPayload, id, options) {
        return (0, fp_js_1.unwrapAsync)((0, roomCreateUser_js_1.roomCreateUser)(this, roomUserPayload, id, options));
    }
    /**
     * Get user details
     *
     ...
     * @deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
     */
    async updateUser(roomUserUpdatePayload, id, userId, options) {
        return (0, fp_js_1.unwrapAsync)((0, roomUpdateUser_js_1.roomUpdateUser)(this, roomUserUpdatePayload, id, userId, options));
    }
    /**
