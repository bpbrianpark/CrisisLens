...
export declare class Stream extends ClientSDK {
     ...
     * Update a stream
     */
    update(streamPatchPayload: components.StreamPatchPayload, id: string, options?: RequestOptions): Promise<operations.UpdateStreamResponse>;
    /**
     * Delete a stream
     *
     * @remarks
     ...
     */
    addMultistreamTarget(targetAddPayload: components.TargetAddPayload, id: string, options?: RequestOptions): Promise<operations.AddMultistreamTargetResponse>;
    /**
