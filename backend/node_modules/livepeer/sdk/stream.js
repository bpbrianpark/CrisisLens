...
class Stream extends sdks_js_1.ClientSDK {
     ...
     * Update a stream
     */
    async update(streamPatchPayload, id, options) {
        return (0, fp_js_1.unwrapAsync)((0, streamUpdate_js_1.streamUpdate)(this, streamPatchPayload, id, options));
    }
    /**
     * Delete a stream
     *
     ...
     */
    async addMultistreamTarget(targetAddPayload, id, options) {
        return (0, fp_js_1.unwrapAsync)((0, streamAddMultistreamTarget_js_1.streamAddMultistreamTarget)(this, targetAddPayload, id, options));
    }
    /**
